...
public class DatabaseQueryEngine
{
	public static void main(String[] args)
	{
		...
		String YOUR_CS_USER_NAME = "";  // you must type your CS user name here
		String YOUR_CS_PASSWORD = ""; // you must type your password here - BE CAREFUL don't share this with anyone. 
		...
		String The_Query_To_Run = "select sum(credits) as total from modules,studies,allstudents where (studies.studentID = allstudents.studentID and modules.modulecode = studies.modulecode) and allstudents.fullname like 'Barbara Ray'";
